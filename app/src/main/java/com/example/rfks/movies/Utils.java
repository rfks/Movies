...
public class Utils {
    ...
    /**
     * Query the movies dataset and return a list of {@link Movie} objects.
     */
    ...
    public static List<Movie> extractFeatureFromJson(String movieJSON) {
        ...
        try {
            ...
            // For each article in the movieArray, create an {@link Movie} object
            for (int i = 0; i < movieArray.length(); i++) {
                ...
                String avg_vote = currentMovie.getString("vote_average");
